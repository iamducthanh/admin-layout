(function(e){"function"===typeof define&&define.amd?define(["jquery","https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-buttons/js/datatables.net","datatables.net-buttons"],function(f){return e(f,window,document)}):"object"===typeof exports?module.exports=function(f,a){f||(f=window);if(!a||!a.fn.dataTable)a=require("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-buttons/js/datatables.net")(f,a).$;a.fn.dataTable.Buttons||require("datatables.net-buttons")(f,a);return e(a,f,f.document)}:e(jQuery,window,document)})(function(e,f,a,n){var i=e.fn.dataTable,c=a.createElement("a"),m=function(b){c.href=b;b=c.host;-1===b.indexOf("/")&&
