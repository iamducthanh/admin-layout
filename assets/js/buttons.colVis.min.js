(function(g){"function"===typeof define&&define.amd?define(["jquery","https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-buttons/js/datatables.net","datatables.net-buttons"],function(e){return g(e,window,document)}):"object"===typeof exports?module.exports=function(e,f){e||(e=window);if(!f||!f.fn.dataTable)f=require("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-buttons/js/datatables.net")(e,f).$;f.fn.dataTable.Buttons||require("datatables.net-buttons")(e,f);return g(f,e,e.document)}:g(jQuery,window,document)})(function(g,e,f,h){e=g.fn.dataTable;g.extend(e.ext.buttons,{colvis:function(a,b){return{extend:"collection",
