...
*/
(function(e){"function"===typeof define&&define.amd?define(["jquery","https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-buttons/js/datatables.net"],function(q){return e(q,window,document)}):"object"===typeof exports?module.exports=function(q,r){q||(q=window);if(!r||!r.fn.dataTable)r=require("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-buttons/js/datatables.net")(q,r).$;return e(r,q,q.document)}:e(jQuery,window,document)})(function(e,q,r,m){function w(a,b,c){e.fn.animate?a.stop().fadeIn(b,c):(a.css("display","block"),c&&c.call(a))}function x(a,b,c){e.fn.animate?a.stop().fadeOut(b,c):(a.css("display","none"),c&&
...
p;e.fn.DataTable.Buttons=p;e(r).on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-buttons/js/init.dt plugin-init.dt",function(a,b){if("dt"===a.namespace){var c=b.oInit.buttons||i.defaults.buttons;c&&!b._buttons&&(new p(b,c)).container()}});i.ext.feature.push({fnInit:z,cFeature:"B"});i.ext.features&&i.ext.features.register("buttons",z);return p});
