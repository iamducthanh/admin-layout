...
*/
(function(c){"function"===typeof define&&define.amd?define(["jquery","https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-bs4/js/datatables.net"],function(a){return c(a,window,document)}):"object"===typeof exports?module.exports=function(a,d){a||(a=window);if(!d||!d.fn.dataTable)d=require("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-bs4/js/datatables.net")(a,d).$;return c(d,a,a.document)}:c(jQuery,window,document)})(function(c,a,d,m){var f=c.fn.dataTable;c.extend(!0,f.defaults,{dom:"<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
