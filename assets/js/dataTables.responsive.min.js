...
*/
(function(d){"function"===typeof define&&define.amd?define(["jquery","https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/datatables.net"],function(m){return d(m,window,document)}):"object"===typeof exports?module.exports=function(m,l){m||(m=window);if(!l||!l.fn.dataTable)l=require("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/datatables.net")(m,l).$;return d(l,m,m.document)}:d(jQuery,window,document)})(function(d,m,l,q){function t(a,b,c){var e=b+"-"+c;if(n[e])return n[e];for(var d=[],a=a.cell(b,c).node().childNodes,b=0,c=a.length;b<c;b++)d.push(a[b]);return n[e]=d}function r(a,b,c){var e=b+
"-"+c;if(n[e]){for(var a=a.cell(b,c).node(),c=n[e][0].parentNode.childNodes,b=[],d=0,g=c.length;d<g;d++)b.push(c[d]);c=0;for(d=b.length;c<d;c++)a.appendChild(b[c]);n[e]=q}}var o=d.fn.dataTable,i=function(a,b){if(!o.versionCheck||!o.versionCheck("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/1.10.10"))throw"DataTables Responsive requires DataTables 1.10.10 or newer";this.s={dt:new o.Api(a),columns:[],current:[]};this.s.dt.settings()[0].responsive||(b&&"string"===typeof b.details?b.details={type:b.details}:b&&!1===b.details?b.details={type:!1}:
b&&!0===b.details&&(b.details={type:"inline"}),this.c=d.extend(!0,{},i.defaults,o.defaults.responsive,b),a.responsive=this,this._constructor())};d.extend(i.prototype,{_constructor:function(){var a=this,b=this.s.dt,c=b.settings()[0],e=d(m).innerWidth();b.settings()[0]._responsive=this;d(m).on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/resize.dtr orientationchange.dtr",o.util.throttle(function(){var b=d(m).innerWidth();b!==e&&(a._resize(),e=b)}));c.oApi._fnCallbackReg(c,"aoRowCreatedCallback",function(c){-1!==d.inArray(!1,a.s.current)&&d(">td, >th",
c).each(function(c){c=b.column.index("toData",c);!1===a.s.current[c]&&d(this).css("display","none")})});b.on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/destroy.dtr",function(){b.off(".dtr");d(b.table().body()).off(".dtr");d(m).off("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/resize.dtr orientationchange.dtr");b.cells(".dtr-control").nodes().to$().removeClass("dtr-control");d.each(a.s.current,function(b,c){!1===c&&a._setColumnVis(b,!0)})});this.c.breakpoints.sort(function(a,b){return a.width<b.width?1:a.width>b.width?-1:0});this._classLogic();this._resizeAuto();c=this.c.details;!1!==
c.type&&(a._detailsInit(),b.on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/column-visibility.dtr",function(){a._timer&&clearTimeout(a._timer);a._timer=setTimeout(function(){a._timer=null;a._classLogic();a._resizeAuto();a._resize(!0);a._redrawChildren()},100)}),b.on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/draw.dtr",function(){a._redrawChildren()}),d(b.table().node()).addClass("dtr-"+c.type));b.on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/column-reorder.dtr",function(){a._classLogic();a._resizeAuto();a._resize(true)});b.on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/column-sizing.dtr",function(){a._resizeAuto();a._resize()});b.on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/preXhr.dtr",function(){var c=[];
b.rows().every(function(){this.child.isShown()&&c.push(this.id(true))});b.one("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/draw.dtr",function(){a._resizeAuto();a._resize();b.rows(c).every(function(){a._detailsDisplay(this,false)})})});b.on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/draw.dtr",function(){a._controlClass()}).on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/init.dtr",function(c){if(c.namespace==="dt"){a._resizeAuto();a._resize();d.inArray(false,a.s.current)&&b.columns.adjust()}});this._resize()},_columnsVisiblity:function(a){var b=this.s.dt,c=this.s.columns,e,f,g=c.map(function(a,b){return{columnIdx:b,priority:a.priority}}).sort(function(a,
...
b,function(){return f.renderer(e,a[0],c._detailsObj(a[0]))});(!0===g||!1===g)&&d(e.table().node()).triggerHandler("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/responsive-display.dt",[e,a,g,b])}},_detailsInit:function(){var a=this,b=this.s.dt,c=this.c.details;"inline"===c.type&&(c.target="td.dtr-control, th.dtr-control");b.on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/draw.dtr",function(){a._tabIndexes()});a._tabIndexes();d(b.table().body()).on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/keyup.dtr","td, th",function(a){a.keyCode===13&&d(this).data("dtr-keyboard")&&d(this).click()});var e=c.target;if(e!==q||null!==e)d(b.table().body()).on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/click.dtr mousedown.dtr mouseup.dtr",
...
d){!0===k[d]&&n++;if(a||k[d]!==i[d])l=!0,b._setColumnVis(c,k[d])});l&&(this._redrawChildren(),d(c.table().node()).trigger("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/responsive-resize.dt",[c,this.s.current]),0===c.page.info().recordsDisplay&&d("td",c.table().body()).eq(0).attr("colspan",n));b._controlClass()},_resizeAuto:function(){var a=this.s.dt,b=this.s.columns;if(this.c.auto&&-1!==d.inArray(!0,d.map(b,function(a){return a.auto}))){d.isEmptyObject(n)||d.each(n,function(b){b=b.split("-");r(a,1*b[0],1*b[1])});a.table().node();var c=a.table().node().cloneNode(!1),
...
d(l).off("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/keypress.dtr")},g=d('<div class="dtr-modal"/>').append(d('<div class="dtr-modal-display"/>').append(d('<div class="dtr-modal-content"/>').append(e())).append(d('<div class="dtr-modal-close">&times;</div>').click(function(){f()}))).append(d('<div class="dtr-modal-background"/>').click(function(){f()})).appendTo("body");d(l).on("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/keyup.dtr",function(a){27===a.keyCode&&(a.stopPropagation(),f())})}a&&a.header&&d("div.dtr-modal-content").prepend("<h2>"+a.header(b)+"</h2>")}}};var n={};i.renderer=
